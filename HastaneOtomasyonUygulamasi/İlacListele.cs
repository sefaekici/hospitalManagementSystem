...
{
    public partial class İlacListele : Form
    {
        public İlacListele()
        {
            InitializeComponent();
        ...
        private void İlacListele_Load(object sender, EventArgs e)
        {
            baglanti.Open();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter("select * from Ilac", baglanti);
            da.Fill(dt);
